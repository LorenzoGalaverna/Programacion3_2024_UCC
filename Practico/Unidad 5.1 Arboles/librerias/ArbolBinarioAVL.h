 ...
 * @tparam K Clave por la cual va a ordenar el ?rbol
 * @tparam T Valor guardado por el ?rbol
 */
template <class T>
...
/**
 * Busca un dato en el ?rbol. Si no esta el dato en el ?rbol
 * tira una excepci?n
